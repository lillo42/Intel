...
QT_MOC_LITERAL(7, 56, 12)
    ...
    "TcpServer\0reciveDate\0\0data\0port\0"
    "newConnection\0readReady\0disconnected"
};
...
void TcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->reciveDate((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpServer::reciveDate)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void TcpServer::reciveDate(QByteArray _t1, int _t2)
{
